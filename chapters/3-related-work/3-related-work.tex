...
As with Barlow Twins, a batch $D$ is augmented to create two views and passed through an encoder and projector. The embedding $Z$ and $Z'$ are \textit{whitened} \todo{define or elaborate on this} using IterNorm \cite{huang2019iterative}.\newline
